...
macro InsertFileHeaderEN(hbuf, ln,szName,szContent)
{
    ...
    InsBufLine(hbuf, ln + 2,  "  Copyright (C), zhht, Ltd.")
...
macro InsertFileHeaderCN(hbuf, ln,szName,szContent)
{
    ...
    InsBufLine(hbuf, ln + 0,  "/******************************************************************************")
    InsBufLine(hbuf, ln + 1,  "")
    InsBufLine(hbuf, ln + 2,  "                  °æÈ¨ËùÓÐ (C), ÖÇ»Û»¥Í¨¿Æ¼¼ÓÐÏÞ¹«Ë¾")
    InsBufLine(hbuf, ln + 3,  "")
    InsBufLine(hbuf, ln + 4,  " ******************************************************************************")
    sz = GetFileName(GetBufName (hbuf))
    ...
    InsBufLine(hbuf, ln + 52, "")
    InsBufLine(hbuf, ln + 53, "")
    InsBufLine(hbuf, ln + 54, "/*********************COPYRIGHT(c) ÖÇ»Û»¥Í¨******End of File*****************/")
...
macro FuncHeadCommentEN(hbuf, ln, szFunc, szMyName,newFunc)
{
    ...
    {       
            ln = ln + 1
            InsBufLine(hbuf, ln+2, " Output       : None")
    }
